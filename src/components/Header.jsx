    ...
    <header>
      <div className="logo">
        <div className="logo-mark">
          ...
          AI Sprint <span className="logo-accent">Planner</span>
        </div>
        <span className="logo-tagline">Agile planning, accelerated by AI</span>
      </div>
      <span className="header-tag">by Forma AI</span>
    </header>
  )
}
